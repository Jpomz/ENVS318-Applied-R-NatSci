...
### Install tinyTeX in Terminal

-   Go to the "Terminal" tab in your console  

-   Type `quarto install tinytex` and press enter

-   Wait until it finishes before moving on to the next steps. 

## Open a Quarto document

-   New file drop down icon in top right of Rstudio
...
-   This code ensures that the html rendered document can be read by other machines, even if they don't have all the libraries and software downloaded on their local machine.  

-   The PDF should work under default settings

## Render your Quarto

-   You can render your document into an .html or .pdf document by clicking the dropdown arrow by the "render" at the top and selecting the output. 
...
-   **If you cannot get a pdf to work**

    -   You may render and submit html documents on D2L
...
-   When you're ready to make your output, click on the drop down menu by "Render" and choose the correct output. 
