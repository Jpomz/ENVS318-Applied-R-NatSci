...
-   If you get an error about `tlmgr` or "Local TeX Live", you may need to install a new version of Tex Live  

    -   For Macs, go [here](https://tug.org/mactex/)
    -   For Windows, go [here](https://tug.org/texlive/windows.html)
...
-   to change the output to pdf, just switch `format: html` to `format: pdf`
    ...
    -   If this doesn't work, try clicking in your terminal (tab in console pane) and type:
